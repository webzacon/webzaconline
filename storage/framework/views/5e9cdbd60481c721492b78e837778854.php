...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('invena-main/assets/images/fav.png')); ?>">
    <title>Invena Business Consulting HTML Template</title>
    <link rel="stylesheet preload" href="<?php echo e(asset('invena-main/assets/css/plugins/fontawesome.css')); ?>" as="style">
    <link rel="stylesheet preload" href="<?php echo e(asset('invena-main/assets/css/plugins/swiper.css')); ?>" as="style">
    <link rel="stylesheet preload" href="<?php echo e(asset('invena-main/assets/css/plugins/metismenu.css')); ?>" as="style">
    <link rel="stylesheet preload" href="<?php echo e(asset('invena-main/assets/css/plugins/magnifying-popup.css')); ?>" as="style">
    <link rel="stylesheet preload" href="<?php echo e(asset('invena-main/assets/css/plugins/odometer.css')); ?>" as="style">
    <link rel="stylesheet preload" href="<?php echo e(asset('invena-main/assets/css/vendor/bootstrap.min.css')); ?>" as="style">
    ...
    <link rel="preload" as="image" href="<?php echo e(asset('invena-main/assets/images/banner/21.webp')); ?>" />
    <link rel="stylesheet preload" href="<?php echo e(asset('invena-main/assets/css/style.css')); ?>" as="style">
</head>
                    ...
                    <div class="header-main-one-wrapper">
                        <div class="thumbnail">
                            <a href="<?php echo e(route('home')); ?>">
                                <img src="<?php echo e(asset('images/logo.jpg')); ?>" alt="finbiz-logo" style="max-width: 150px; width: 100%; height: auto;">
                            </a>
                        </div>
                        <div class="main-header">
                            <div class="nav-area">
    <ul class="">
        <li class="main-nav"><a href="<?php echo e(route('home')); ?>">Home</a></li>
        <li class="main-nav"><a href="<?php echo e(route('about')); ?>">About</a></li>
        <li class="main-nav"><a href="<?php echo e(route('services')); ?>">Services</a></li>
        <li class="main-nav"><a href="<?php echo e(route('pricing')); ?>">Pricing</a></li>
        <li class="main-nav"><a href="<?php echo e(route('contact')); ?>">Contact</a></li>
    </ul>
</div>
...
<div class="loader-wrapper">
    ...
    <div class="loader-section section-right"></div>
                            ...
                            <div class="button-area">
                                ...
                                <button id="menu-btn" aria-label="Menu" class="menu-btn menu ml--20 ml_sm--5">
                                    <img class="menu-light" src="<?php echo e(asset('invena-main/assets/images/icons/01.svg')); ?>" alt="Menu-icon">
                                </button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="swiper-wrapper">
                    ...
                    <div class="rts-banner-area-two rts-section-gap bg_image">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="banner-inner-two-content">
                                        ...
                                        <a href="<?php echo e(route('contact')); ?>" class="rts-btn btn-primary btn-white">Start Project</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="shape-area-start">
                            <div class="shape shape-one">
                                <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/banner/shape/01.webp')); ?>" alt="shape-area">
                            </div>
                            <div class="shape shape-two">
                                <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/banner/shape/02.webp')); ?>" alt="shape-area">
                            </div>
                            <div class="shape shape-three">
                                <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/banner/shape/03.webp')); ?>" alt="shape-area">
                            </div>
                            <div class="shape shape-four">
                                <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/banner/shape/04.webp')); ?>" alt="shape-area">
                            </div>
                        </div>
                    </div>
                    <!-- rts banner area end -->
                ...
                <div class="swiper-slide">
                    ...
                    <div class="rts-banner-area-two two rts-section-gap bg_image">
                        ...
                        <div class="shape-area-start">
                            <div class="shape shape-one">
                                <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/banner/shape/01.webp')); ?>" alt="">
                            </div>
                            <div class="shape shape-two">
                                <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/banner/shape/02.webp')); ?>" alt="">
                            </div>
                            <div class="shape shape-three">
                                <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/banner/shape/03.webp')); ?>" alt="">
                            </div>
                            <div class="shape shape-four">
                                <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/banner/shape/04.webp')); ?>" alt="">
                            </div>
                        </div>
                    </div>
                    <!-- rts banner area end -->
    ...
    <div class="rts-about-area-two rts-section-gap">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="left-thumbnail-about-area-two">
                        <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/about/04.webp')); ?>" alt="about">
                        <div class="small-image">
                            <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/about/05.webp')); ?>" alt="small">
                        </div>
                ...
                <div class="col-lg-6 mt_sm--80 mt_md--80">
                    <div class="about-inner-content-two">
                        ...
                        <div class="call-and-sign-area two">
                            ...
                            <div class="sign-area">
                                <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/about/sign.svg')); ?>" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="shape-area">
            <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/about/shape/01.svg')); ?>" alt="shape" class="one">
            <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/about/shape/02.svg')); ?>" alt="shape" class="two">
        </div>
    </div>
    <!-- rts about area end -->
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="single-service-signle-wrapper">
                                                    <div class="icons">
                                                        <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/service/icons/01.svg')); ?>"
                                                            alt="service">
                                                    </div>
                                                    <div class="information">
                                                        ...
                                                        <a href="<?php echo e(route('services')); ?>" class="arrow-right">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="single-service-signle-wrapper">
                                                    <div class="icons">
                                                        <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/service/icons/02.svg')); ?>"
                                                            alt="service">
                                                    </div>
                                                    <div class="information">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="single-service-signle-wrapper">
                                                    <div class="icons">
                                                        <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/service/icons/03.svg')); ?>"
                                                            alt="service">
                                                    </div>
                                                    <div class="information">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="cta-style-two-area">
                                    ...
                                    <a href="<?php echo e(route('contact')); ?>" class="rts-btn btn-primary btn-white">Let's Work Together</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="consultancy-style-one">
                        ...
                        <div class="signle-consultancy mb--30">
                            <div class="icon">
                                <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/about/icons/01.svg')); ?>" alt="">
                            </div>
                            <div class="information">
                        ...
                        <div class="signle-consultancy">
                            <div class="icon">
                                <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/about/icons/02.svg')); ?>" alt="">
                            </div>
                            <div class="information">
                        ...
                        <div class="button-wrapper mt--40" data-animation="fadeInUp" data-delay="0.4"
                            data-duration="1.2">
                            <a href="<?php echo e(route('contact')); ?>" class="rts-btn btn-primary">Contact Us</a>
                ...
                <div class="col-lg-6">
                    <div class="thumbnail-business-area-right-two">
                        <div class="large-thumbnail">
                            <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/business-goal/02.webp')); ?>" alt="">
                        </div>
                        <div class="small-thumbnail images-r">
                            <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/business-goal/01.webp')); ?>" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="single-counter">
                        <div class="icon">
                            <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/counterup/icon/01.svg')); ?>" alt="Business_counter">
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="single-counter pl--10 justify-content-center two pl--30">
                        <div class="icon">
                            <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/counterup/icon/02.svg')); ?>" alt="Business_counter">
                        </div>
                        <div class="counter-details">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="single-counter pl--10 justify-content-center three pl--50 pl_md--10 pl_sm--0">
                        <div class="icon">
                            <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/counterup/icon/03.svg')); ?>" alt="Business_counter">
                        </div>
                        <div class="counter-details">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="single-counter pl--10 four">
                        <div class="icon">
                            <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/counterup/icon/04.svg')); ?>" alt="Business_counter">
                        </div>
                        <div class="counter-details">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="project-style-one">
                                        <a href="<?php echo e(route('services')); ?>" class="thumbnail">
                                            <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/project/01.webp')); ?>" alt="project">
                                        </a>
                                ...
                                <div class="swiper-slide">
                                    <div class="project-style-one">
                                        <a href="<?php echo e(route('services')); ?>" class="thumbnail">
                                            <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/project/02.webp')); ?>" alt="project">
                                        </a>
                                        <div class="inner-content">
                                            <a href="<?php echo e(route('services')); ?>">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="appoinment-thumbnail">
                        <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/appoinment/01.webp')); ?>" alt="appoinment">
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="single-blog-area-one">
                                        ...
                                        <div class="bottom-details">
                                            <a href="<?php echo e(route('about')); ?>" class="thumbnail">
                                                <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/blog/01.webp')); ?>" alt="blog-area">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="single-blog-area-one">
                                        ...
                                        <div class="bottom-details">
                                            <a href="<?php echo e(route('about')); ?>" class="thumbnail">
                                                <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/blog/02.webp')); ?>" alt="blog-area">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="single-blog-area-one">
                                        ...
                                        <div class="bottom-details">
                                            <a href="<?php echo e(route('about')); ?>" class="thumbnail">
                                                <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/blog/03.webp')); ?>" alt="blog-area">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5">
                                <div class="map-information-2-footer">
                                    ...
                                    <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/footer/02.svg')); ?>" alt="line" class="line">
                ...
                <div class="col-xl-4 col-md-6 col-sm-12 col-12">
                    <div class="footer-one-single-wized mid-bg">
                        <div class="wized-title">
                            ...
                            <img loading="lazy" src="<?php echo e(asset('invena-main/assets/images/footer/01.svg')); ?>" alt="finbiz_footer">
                        </div>
                        <div class="opening-time-inner">
                            ...
                            <a href="<?php echo e(route('contact')); ?>" class="rts-btn btn-primary btn-white">Contact</a>
                        </div>
                    </div>
                </div>
                <!-- footer mid area end -->
                <div class="col-xl-4 col-md-6 col-sm-12 col-12 pl--50 pl_sm--15">
                    <div class="footer-one-single-wized">
                        ...
                        <div class="quick-link-inner">
                            <ul class="links">
                                <li><a href="<?php echo e(route('home')); ?>"><i class="far fa-arrow-right"></i> Home</a></li>
                                <li><a href="<?php echo e(route('about')); ?>"><i class="far fa-arrow-right"></i> About</a></li>
                                <li><a href="<?php echo e(route('services')); ?>"><i class="far fa-arrow-right"></i> Services</a></li>
                                <li><a href="<?php echo e(route('pricing')); ?>"><i class="far fa-arrow-right"></i> Pricing</a></li>
                                <li><a href="<?php echo e(route('contact')); ?>"><i class="far fa-arrow-right"></i> Contact</a></li>
                            </ul>
                        ...
                        <div class="body">
                            <div class="update-wrapper">
                                <p class="disc">Sign up for our latest news &amp; articles. We won’t give you spam
                                    mails.</p>
                                <form class="email-footer-area" action="<?php echo e(route('contact')); ?>" method="get">
    ...
    <div class="rts-sidebar-menu-desktop">
        <a class="logo-1" href="<?php echo e(route('home')); ?>"><img class="logo" src="<?php echo e(asset('images/logo.jpg')); ?>" alt="finbiz_logo" style="max-width: 150px; width: 100%; height: auto;"></a>
    ...
    <nav class="nav-main mainmenu-nav mt--30">
        <ul class="mainmenu metismenu" id="mobile-menu-active">
            <li><a href="<?php echo e(route('home')); ?>" class="main">Home</a></li>
            <li><a href="<?php echo e(route('about')); ?>" class="main">About</a></li>
            <li><a href="<?php echo e(route('services')); ?>" class="main">Services</a></li>
            <li><a href="<?php echo e(route('pricing')); ?>" class="main">Pricing</a></li>
            <li><a href="<?php echo e(route('contact')); ?>" class="main">Contact</a></li>
        </ul>
    </nav>
...
<script defer src="<?php echo e(asset('invena-main/assets/js/plugins/jquery.js')); ?>"></script>

<script defer src="<?php echo e(asset('invena-main/assets/js/plugins/odometer.js')); ?>"></script>
<script defer src="<?php echo e(asset('invena-main/assets/js/plugins/jquery-appear.js')); ?>"></script>


<script defer src="<?php echo e(asset('invena-main/assets/js/plugins/gsap.js')); ?>"></script>
<script defer src="<?php echo e(asset('invena-main/assets/js/plugins/split-text.js')); ?>"></script>
<script defer src="<?php echo e(asset('invena-main/assets/js/plugins/scroll-trigger.js')); ?>"></script>
<script defer src="<?php echo e(asset('invena-main/assets/js/plugins/smooth-scroll.js')); ?>"></script>
<script defer src="<?php echo e(asset('invena-main/assets/js/plugins/metismenu.js')); ?>"></script>
<script defer src="<?php echo e(asset('invena-main/assets/js/plugins/popup.js')); ?>"></script>

<script defer src="<?php echo e(asset('invena-main/assets/js/vendor/bootstrap.min.js')); ?>"></script>
<script defer src="<?php echo e(asset('invena-main/assets/js/plugins/swiper.js')); ?>"></script>
<script defer src="<?php echo e(asset('invena-main/assets/js/plugins/contact.form.js')); ?>"></script>

<script defer src="<?php echo e(asset('invena-main/assets/js/main.js')); ?>"></script>
</body>

</html>
<?php /**PATH D:\xampp\htdocs\web\resources\views/index.blade.php ENDPATH**/ ?>