...
<head>
    ...
    <meta name="description" content="Contact Webzac for website development, ecommerce, software development, digital marketing, and mobile apps.">
    <meta name="keywords" content="Contact Webzac, Webzac address, Webzac phone number, Webzac email, Tiruppur software company, web development contact, digital marketing agency contact">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('invena-main/assets/images/fav.png') }}">
    <title>Contact Webzac | Tiruppur, Tamil Nadu, India</title>
...
<div class="loader-wrapper">
    ...
    <div class="rts-breadcrumb-area">
        ...
        <div class="shape-area">
            <img src="{{ asset('invena-main/assets/images/about/shape/01.png') }}" alt="shape" class="one">
            <img src="{{ asset('invena-main/assets/images/about/shape/02.png') }}" alt="shape" class="two">
            <img src="{{ asset('invena-main/assets/images/about/shape/03.png') }}" alt="shape" class="three">
        </div>
    </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="thumbnail-contact-form">
                        <img src="{{ asset('invena-main/assets/images/contact/01.webp') }}" alt="contact">
                    </div>
                </div>
                <div class="col-lg-3">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="google-map">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3914.2411310385787!2d77.29791707402255!3d11.16977395181729!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba907fd5efeef6f%3A0x64cd6da788ff70a5!2sTIDEL%20NEO%20-%20TIRUPPUR!5e0!3m2!1sen!2sin!4v1772011894911!5m2!1sen!2sin" width="800" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="footer-logo-area-left-8">
                        <a href="#" class="logo">
                            <img src="{{ asset('images/logo.jpg') }}" alt="logo" style="max-width: 150px; width: 100%; height: auto;">
                        </a>
                        <p class="disc">
                ...
                <div class="offset-lg-1 col-lg-4">
                    <div class="footer-one-single-wized">
                        <div class="wized-title">
                            ...
                            <img src="{{ asset('invena-main/assets/images/footer/under-title.png') }}" alt="finbiz_footer">
                        </div>
