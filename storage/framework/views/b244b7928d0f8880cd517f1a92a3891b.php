    ...
    <div class="container">
        ...
        <div class="row main-header main-header-three">
            <div class="col-lg-3 col-md-4 col-sm-5 col-5">
                <a href="<?php echo e(route('home')); ?>" class="thumbnail-logo">
                    <img src="<?php echo e(asset('images/logo.jpg')); ?>" alt="Logo_three" class="about-header-logo" style="max-width: 150px; width: 100%; height: auto;">
                </a>
            </div>
...
<div class="loader-wrapper">
    ...
    <div class="loader-section section-right"></div>
            ...
            <div class="col-xl-3 col-lg-9 col-md-8 col-sm-7 col-7">
                <div class="button-area-wrapper">
                    <a href="<?php echo e(route('contact')); ?>" class="rts-btn btn-primary ml--20 ml_sm--5 header-one-btn quote-btn">Get
                        Quote</a>
    ...
    <div class="rts-banner-five-wrapper rts-section-gapBottom">
                ...
                <div class="col-lg-12">
                    <div class="banner-five-content">
                        ...
                        <div class="description-area">
                            ...
                            <a href="<?php echo e(route('services')); ?>" class="rts-btn btn-primary">Our Services</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row align-items-center mt--65">
                <div class="col-lg-9">
                    <div class="banner-image-primary-five">
                        <img class="grow" src="<?php echo e(asset('invena-main/assets/images/banner/05.webp')); ?>" alt="banner">
                    </div>
                </div>
                <div class="col-lg-3">
        ...
        <div class="shape-area">
            <img src="<?php echo e(asset('invena-main/assets/images/banner/shape/05.png')); ?>" alt="shape" class="one">
            <img src="<?php echo e(asset('invena-main/assets/images/banner/shape/06.png')); ?>" alt="shape" class="two">
            <img src="<?php echo e(asset('invena-main/assets/images/banner/shape/07.png')); ?>" alt="shape" class="three">
        </div>
    </div>
            ...
            <div class="row g-5 mt--10">
                <div class="col-lg-4 col-md-6 col-sm-12" data-animation="fadeInUp" data-delay="0.0" data-duration="1.2">
                    <div class="service-single-main-wrapper-five">
                        <div class="icon">
                            <img src="<?php echo e(asset('invena-main/assets/images/service/icons/08.svg')); ?>" alt="service">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12" data-animation="fadeInUp" data-delay="0.2" data-duration="1.2">
                    <div class="service-single-main-wrapper-five">
                        <div class="icon">
                            <img src="<?php echo e(asset('invena-main/assets/images/service/icons/09.svg')); ?>" alt="service">
                        </div>
                        <div class="inner-content">
                            <a href="service-details.html">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12" data-animation="fadeInUp" data-delay="0.4" data-duration="1.2">
                    <div class="service-single-main-wrapper-five">
                        <div class="icon">
                            <img src="<?php echo e(asset('invena-main/assets/images/service/icons/10.svg')); ?>" alt="service">
                        </div>
                        <div class="inner-content">
                            <a href="service-details.html">
                    ...
                    <div class="progress-circle-main-wrapper">
                        <div class="single-progress-area">
                            <div class="single-progress-circle">
                                ...
                                <img src="<?php echo e(asset('invena-main/assets/images/fun/01.svg')); ?>" alt="fun">
                            </div>
                        ...
                        <div class="single-progress-area">
                            <div class="single-progress-circle">
                                ...
                                <img src="<?php echo e(asset('invena-main/assets/images/fun/02.svg')); ?>" alt="fun">
                            </div>
                            <div class="right-counter">
                        ...
                        <div class="single-progress-area">
                            <div class="single-progress-circle">
                                ...
                                <img src="<?php echo e(asset('invena-main/assets/images/fun/03.svg')); ?>" alt="fun">
                            </div>
                            <div class="right-counter">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 pr--70 pr_md--0 pr_sm--0">
                    <div class="thumbnail-about-five">
                        <img src="<?php echo e(asset('invena-main/assets/images/about/10.webp')); ?>" alt="">
                    </div>
                </div>
                    ...
                    <div class="about-content-inner-five">
                        ...
                        <div class="inner-about-home-7">
                            ...
                            <div class="about-single-home-7">
                                <div class="icon">
                                    <img src="<?php echo e(asset('invena-main/assets/images/about/icons/03.svg')); ?>" alt="">
                                </div>
                            ...
                            <div class="about-single-home-7">
                                <div class="icon">
                                    <img src="<?php echo e(asset('invena-main/assets/images/about/icons/04.svg')); ?>" alt="">
                                </div>
                                <div class="discription">
                                    <h6 class="title">
                                        Strong Execution
                            ...
                            <div class="about-single-home-7">
                                <div class="icon">
                                    <img src="<?php echo e(asset('invena-main/assets/images/about/icons/05.svg')); ?>" alt="">
                                </div>
                                <div class="discription">
                                    <h6 class="title">
                                        Growth Mindset
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="business-groth-5-thumbnail">
                        <img src="<?php echo e(asset('invena-main/assets/images/business/02.webp')); ?>" alt="business">
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="row g-5">
                                        <div class="col-lg-5">
                                            <div class="project-content-left-5">
                                                <div class="icon">
                                                    <img src="<?php echo e(asset('invena-main/assets/images/project/01.svg')); ?>" alt="project">
                                                </div>
                                                <div class="title-area">
                                        ...
                                        <div class="col-lg-7">
                                            <div class="thumbnail-project-5">
                                                <img src="<?php echo e(asset('invena-main/assets/images/project/11.webp')); ?>" alt="project">
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="container">
            ...
            <div class="row g-5 mt--20">
                ...
                <div class="col-lg-4 col-md-6" data-animation="fadeInUp" data-delay="0.0" data-duration="1.2">
                    ...
                    <div class="rts-blog-h-2-wrapper">
                        <a href="blog-details.html" class="thumbnail">
                            <img src="<?php echo e(asset('invena-main/assets/images/blog/04.webp')); ?>" alt="Business_blog">
                        </a>
                        <div class="body">
                ...
                <div class="col-lg-4 col-md-6" data-animation="fadeInUp" data-delay="0.2" data-duration="1.2">
                    ...
                    <div class="rts-blog-h-2-wrapper">
                        <a href="blog-details.html" class="thumbnail">
                            <img src="<?php echo e(asset('invena-main/assets/images/blog/05.webp')); ?>" alt="Business_blog">
                        </a>
                        <div class="body">
                            <span>Business Solution / by David Dolean</span>
                            <a href="blog-details.html">
                ...
                <div class="col-lg-4 col-md-6" data-animation="fadeInUp" data-delay="0.4" data-duration="1.2">
                    ...
                    <div class="rts-blog-h-2-wrapper">
                        <a href="blog-details.html" class="thumbnail">
                            <img src="<?php echo e(asset('invena-main/assets/images/blog/06.webp')); ?>" alt="Business_blog">
                        </a>
                        <div class="body">
                            <span>Business Solution / by David Dolean</span>
                            <a href="blog-details.html">
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 mt_sm--50">
                <div class="footer-two-single-wized two">
                    <div class="wized-title-area">
                        ...
                        <img src="<?php echo e(asset('invena-main/assets/images/footer/01.png')); ?>" alt="Invena_Footer">
                    </div>
                    ...
                    <div class="wized-2-body">
                        <div class="contact-info-1">
                            ...
                            <div class="disc">
                                ...
                                <a href="#">Near Tidel Neo Tech Park, Poondi Nagar - Poondi <br> Tiruppur, Tamil Nadu, India</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="get-in-touch">
                ...
                <div class="wrapper">
                    ...
                    <div class="single">
                        ...
                        <a href="#">www.webzac.online</a>
                    </div>
                    <!-- single ENd -->
                    <!-- single -->
                    <div class="single">
                        <i class="fas fa-map-marker-alt"></i>
                        <a href="#">Near Tidel Neo Tech Park, Poondi Nagar - Poondi, Tiruppur</a>
                    </div>
                    <!-- single ENd -->
                </div>
...
<?php /**PATH D:\xampp\htdocs\web\resources\views/about.blade.php ENDPATH**/ ?>